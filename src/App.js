...
function About() {
  ...
  return (
    <div style={aboutStyle}>
      <ul>
        <h1 className="display-4 text-center pb-4" style={{ color: "hsl(218, 75%, 45%)", fontWeight: "bold" }}>
          PRESS</h1>
        <li>
...
function Albums() {
  return (
    <div id="albums" className="album" style={{ backgroundColor: "hsl(218, 51%, 10%)" }}>
      <div className="container-fluid">
        <h1 className="display-4 text-center pt-5" style={{ color: "hsl(218, 75%, 45%)", fontWeight: "bold" }}>Albums
                    </h1>
        <div className="row">
          <div className="col-md-4">
            <div className="card mb-4 shadow-sm"><img className="bd-placeholder-img card-img-top"
              src={skywardPic} alt="pics" style={{ height: "250px" }} />
              <div className="card-body" id="album">
                <div className="d-flex justify-content-between aligns-center"><iframe title="Skyward"
          ...
          <div className="col-md-4">
            <div className="card mb-4 shadow-sm"><img className="bd-placeholder-img card-img-top"
              src={relicPic} alt="pics" style={{ height: "250px" }} />
              <div className="card-body" id="album">
                <div className="d-flex justify-content-between aligns-center"><iframe title="Relic"
          ...
          <div className="col-md-4">
            <div className="card shadow-sm"><img className="bd-placeholder-img card-img-top"
              src={riftPic} alt="pics" style={{ height: "250px" }} />
              <div className="card-body" id="album">
                <div className="d-flex justify-content-between aligns-center"><iframe title="Rift"
...
class Shows extends Component {
  ...
  componentDidMount() {
    ...
    fetch("https://rest.bandsintown.com/artists/formingthevoid/events?app_id=13706c200eb9a2e94dde6d6e2ffd999a&date=upcoming")
      .then(res => res.json())
      .then(
        (result) => {
          console.log(result);
  ...
  render() {
    ...
    this.state.showData.map((item, key) => {
      ...
      let day2 = `${days[day.getDay()]}, ${months[day.getMonth()]} ${day.getDate()}`;
      item.datetime = day2;
      return contents.push(<tr key={key}><td>{item.datetime + " - " + item.venue.city + ", " } <a href={item.url} > { item.venue.name } </a>  </td></tr>);
    });
